export const dict = {
  ...
  "session.tab.io": "I/O",
  "session.io.empty": "No agent activity yet",
  "session.io.open": "Open I/O panel",
  "session.io.input": "Input",
  "session.io.output": "Output",
  "session.io.error": "Error",
  "session.io.reasoning": "Reasoning",
  "session.io.tokens": "{{input}} in / {{output}} out",
  ...
  "settings.context.agent": "Agent",
  "settings.context.agent.description": "Inspect the model context for this agent.",
  "settings.context.editable.title": "Editable",
  "settings.context.system.title": "Agent system prompt",
  "settings.context.instructions.title": "Instructions (AGENTS.md)",
  "settings.context.environment.title": "Environment",
  "settings.context.skills.title": "Available skills",
  "settings.context.references.title": "Available references",
  "settings.context.readOnly.title": "Read-only",
  "settings.context.save": "Save",
  "settings.context.empty": "Select a project to inspect its model context.",
  "settings.context.emptySource": "Nothing is sent for this source.",
  "settings.context.error": "Failed to load context.",
